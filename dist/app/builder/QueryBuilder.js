...
class QueryBuilder {
    ...
    filter() {
        ...
        const minPrice = queryObj.minPrice != null ? Number(queryObj.minPrice) : undefined;
        const maxPrice = queryObj.maxPrice != null ? Number(queryObj.maxPrice) : undefined;
    ...
    sort() {
        var _a;
        const sortField = (_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.sort;
